...
<nav class="navbar">
    <div class="container nav-container">
        <div class="nav-logo">
            <a href="/Test%20by%20antigravity/viskam_flora_full/index.php" style="display:flex; align-items:center; gap:4px; text-decoration:none;">
        ...
        <div class="search-bar">
            <!-- Basic search form -->
            <form action="/Test%20by%20antigravity/viskam_flora_full/products/index.php" method="GET" style="display:flex;">
        ...
        <ul class="nav-links">
            ...
            <li><a href="/Test%20by%20antigravity/viskam_flora_full/products/index.php">Shop All</a></li>
        ...
        <div class="nav-actions">
            <?php if (isset($_SESSION['user_id'])): ?>
                <?php if($_SESSION['role'] === 'admin'): ?>
                    <a href="/Test%20by%20antigravity/viskam_flora_full/admin/dashboard.php" class="btn btn-outline" style="padding: 5px 15px;">Admin</a>
                <?php endif; ?>
                <div style="position:relative; display:inline-block;" class="profile-dropdown-container">
                    ...
                    <div class="profile-dropdown" style="display:none; position:absolute; right:0; background:#fff; box-shadow:0 4px 8px rgba(0,0,0,0.1); border-radius:5px; padding:10px; min-width:120px; z-index:1001;">
                        <a href="/Test%20by%20antigravity/viskam_flora_full/orders/my_orders.php" style="display:block; padding:8px; color:#333;">My Orders</a>
                        <hr style="margin:5px 0; border:0; border-top:1px solid #eee;">
                        <a href="/Test%20by%20antigravity/viskam_flora_full/auth/logout.php" style="display:block; padding:8px; color:red;">Logout</a>
                    </div>
                </div>
            <?php else: ?>
                <a href="/Test%20by%20antigravity/viskam_flora_full/auth/login_page.php" style="font-weight:600;">Login</a>
                <a href="/Test%20by%20antigravity/viskam_flora_full/auth/register_page.php" class="btn btn-primary" style="padding: 8px 16px;">Sign Up</a>
            <?php endif; ?>
            
            <a href="/Test%20by%20antigravity/viskam_flora_full/cart/cart_page.php" class="cart-icon" aria-label="Cart">
