            ...
            <div style="display:flex; flex-wrap:wrap; gap:30px;">
                ...
                <div style="flex:2; min-width:300px;">
                    <?php foreach ($cart_items as $item): ?>
                        <div class="cart-item">
                            ...
                            <div class="cart-item-details">
                                <a href="<?= BASE_URL ?>products/detail.php?id=<?= $item['id'] ?>"><h4 style="margin-bottom:5px;"><?= htmlspecialchars($item['name']) ?></h4></a>
                    ...
                    <div style="margin-top:20px;">
                        <a href="<?= BASE_URL ?>products/index.php" class="btn btn-outline">← Continue Shopping</a>
                    </div>
                </div>
                ...
                <div style="flex:1; min-width:300px;">
                    <div style="background:#fff; padding:30px; border-radius:var(--border-radius-md); box-shadow:var(--shadow-md); position:sticky; top:100px;">
                        ...
                        <a href="<?= BASE_URL ?>orders/checkout.php" class="btn btn-primary mt-4" style="width:100%; font-size:1.1rem; padding:15px;">Proceed to Checkout</a>
                    </div>
                </div>
            </div>
        <?php endif; ?>
